...
| 구분 | 문서 | 설명 |
|---|---|---|
|  Kubernetes | [Kubernetes 구성 문서](https://github.com/fisagmg/infra/blob/main/kubernetes/kubernetes.md) | Deployment, Service, ConfigMap, Secret 등 Kubernetes 배포 리소스 구성 |
|  CI/CD | [CI/CD 구성 문서 ](https://github.com/fisagmg/infra/blob/main/jenkins/jenkins.md) | Jenkins Pipeline, Docker Build, 배포 자동화 흐름 정리 |
|  Terraform | [Terraform 구성 문서 ](https://github.com/fisagmg/infra/blob/main/terraform/terraform.md) | AWS 인프라 프로비저닝 및 Terraform Runner 구성 |
|  Linux | [Linux 구성 문서](https://github.com/fisagmg/infra/blob/main/ansible-linux-init/linux.md) | Linux 초기 환경 세팅 구성 |
